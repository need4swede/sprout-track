...
export const dropdownMenuStyles = {
  ...
  item: "relative flex cursor-default select-none items-center rounded-md px-4 py-2.5 text-sm font-medium text-gray-700 outline-none transition-colors hover:bg-teal-50 hover:text-teal-700 focus:bg-teal-50 focus:text-teal-700 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 my-0.5",
  itemInset: "pl-8",
  checkboxItem: "relative flex cursor-default select-none items-center rounded-md px-4 py-2.5 pl-8 text-sm font-medium text-gray-700 outline-none transition-colors hover:bg-teal-50 hover:text-teal-700 focus:bg-teal-50 focus:text-teal-700 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 my-0.5",
  sortableCheckboxItem: "relative flex cursor-move select-none items-center rounded-md px-4 py-2.5 pl-8 text-sm font-medium text-gray-700 outline-none transition-colors hover:bg-teal-50 hover:text-teal-700 focus:bg-teal-50 focus:text-teal-700 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 my-0.5",
  dragHandle: "ml-auto flex items-center justify-center h-5 w-5 text-gray-400",
  radioItem: "relative flex cursor-default select-none items-center rounded-md px-4 py-2.5 pl-8 text-sm font-medium text-gray-700 outline-none transition-colors hover:bg-teal-50 hover:text-teal-700 focus:bg-teal-50 focus:text-teal-700 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 my-0.5",
