...
export const dropdownMenuStyles = {
  ...
  sortableCheckboxItem: "relative flex cursor-move select-none items-center rounded-md px-4 py-2.5 pl-8 text-sm font-medium text-gray-700 outline-none transition-colors hover:bg-teal-50 hover:text-teal-700 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 my-0.5",
