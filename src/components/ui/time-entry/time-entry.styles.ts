...
export const timeEntryStyles = {
  ...
  // Header
  header: "bg-emerald-600 text-white p-4 flex justify-center items-center",
  ...
  clockCenter: "absolute w-3 h-3 rounded-full bg-emerald-600 z-10",
  clockHand: "absolute top-1/2 left-1/2 w-1 bg-emerald-600 origin-bottom rounded-full z-0",
  
  // Hour markers
  hourMarker: "absolute w-8 h-8 flex items-center justify-center text-gray-700 font-medium",
  hourMarkerSelected: "bg-emerald-600 text-white rounded-full",
  
  // Minute markers
  minuteMarker: "absolute w-8 h-8 flex items-center justify-center text-gray-700 font-medium",
  minuteMarkerSelected: "bg-emerald-600 text-white rounded-full",
  
  // Minute tick markers (for individual minutes)
  minuteTickMarker: "absolute w-1 h-4 bg-gray-300 rounded-full",
  minuteTickMarkerSelected: "bg-emerald-600",
  ...
  okButton: "bg-emerald-600 text-white hover:bg-emerald-700",
